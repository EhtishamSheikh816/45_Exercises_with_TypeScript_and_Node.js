...
// Inequality test
console.log("Inequality test with strings:", "banana" !== "apple"); //true
...
console.log("Inequality test with number:", 8 !== 4); //true
console.log("Inequality test with number:", 8 == 4); //false
//greater than test 
